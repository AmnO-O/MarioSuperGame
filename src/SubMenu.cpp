...
SubMenu::SubMenu(std::function<void(std::unique_ptr<MenuState>)> switchStateCallback, const std::string& title)
:   new_game_button("NEW GAME", {656, 294, 330, 60}, WHITE, RED, []() {}),
    load_game_button("LOAD GAME", {644, 399, 330, 60}, WHITE, RED, []() {}),
    return_button("D:/MarioSuperGame/assets/images/return_button.png", {25, 27, 100, 100}, [switchStateCallback]() {
        switchStateCallback(std::make_unique<MainMenu>(switchStateCallback));
    }), 
    title(title), 
